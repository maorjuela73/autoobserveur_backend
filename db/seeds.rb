...
miguel.periods.active.first.period_items.create(item: Item.find(23))
miguel.periods.active.first.period_items.create(item: Item.find(25))
miguel.periods.active.first.period_items.create(item: Item.find(26))
