namespace :dataloader do
  ...
  task importItems: :environment do
    CSV.foreach('C:\Users\maorj\Documents\Miguel Orjuela\Autoobservacion\autoobserverur_backend\data\input\items.csv', headers: true) do |row|
  ...
  task importAdvices: :environment do
    CSV.foreach('C:\Users\maorj\Documents\Miguel Orjuela\Autoobservacion\autoobserverur_backend\data\input\advices.csv', headers: true) do |row|
